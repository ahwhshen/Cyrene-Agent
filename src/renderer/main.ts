...
if (!window.cyrene) {
  (window as unknown as { cyrene: unknown }).cyrene = {
    ...
    onPetMirrored: (_cb: (mirrored: boolean) => void) => () => {},
...
let petMirrorOff: (() => void) | null = null;
...
const manager = new Live2DManager({
  ...
  onLoad: () => {
    ...
    petMirrorOff = trackSubscription("cyrene:onPetMirrored", window.cyrene.onPetMirrored((mirrored) => manager.applyMirror(mirrored)));
