...
export const IPC = {
  ...
  // settings 窗口自定义缩放手柄：透明无边框窗口没有系统原生拖拽边缘，由渲染层按增量调整
  SETTINGS_RESIZE_BY: "settings:resize-by",
  ...
  SETTINGS_SYNC_NOW: "settings:sync-now",
  SETTINGS_SYNC_CHAT_HISTORY: "settings:sync-chat-history",
  ...
  PET_ZOOM: "pet:zoom",
  // main → pet window：推送镜像开关，渲染进程据此水平翻转模型
  PET_MIRRORED: "pet:mirrored",
...
// sticker manager window
  ...
  // plugin pack (external extension system)
